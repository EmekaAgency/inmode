        ...
        <Layout>
            ...
            <div className="privacy-policies">
                <div className="container">
                    ...
                    <div className="content">
                        IMD FRANCE - SARL au capital de 5000 Euros -
                    </div>
                    <div className="content">
                        RCS de Paris - 12 place Dauphine, 75001 PARIS -
                    </div>
                    <div className="content">
                        contact.fr@inmodemd.com
                    </div>


                    <div className="title">Responsable de publication : </div>
                    <div className="content">
                        Kevin Lesieutre
                    </div>
                    <div className="content">
                    ...
                    <div className="title">Conditions d’utilisation</div>
                    ...
                    <div className="title">Interactivité</div>
                    <div className="content">
                    ...
                    <div className="title title-section">Liens</div>

                    <div className="title">Liens sortants</div>
                    <div className="content">
                    ...
                    <div className="title">Liens entrants</div>
                    <div className="content">
                    ...
                    <div className="title">Crédits :</div>
                    <div className="content">
