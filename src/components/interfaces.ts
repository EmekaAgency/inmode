...
export interface SogecommerceOrder {
    ...
    vads_url_cancel?: string;// "https://www.inmodeuk.emeka.fr/payment/cancel"
    vads_url_refused?: string;// "https://www.inmodeuk.emeka.fr/payment/refused"
    vads_url_success?: string;// "https://www.inmodeuk.emeka.fr/payment/paid"
